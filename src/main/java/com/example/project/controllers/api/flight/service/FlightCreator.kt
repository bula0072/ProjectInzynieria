...
/**
 * Obdługuje system tworzenia nowych lotów
 */
@Service
class FlightCreator(
	...
	/**
	 * Tworzy lot
	 * @param flight parametry nowego lotu
	...
	/**
	 * Sprawdza poprawność danych podanych przez formularz dodawania nowego lotu.
	 * Jeżeli formularz został wypełniony poprawnie do bazy dodawany jest nowy lot o podanych parametrach.
	 * @param flight parametry nowego lotu
	 * @return Flight
	 */
